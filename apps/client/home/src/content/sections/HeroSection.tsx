...
export default class HeroSection extends React.Component {
  render() {
    ...
    const background_color = _.get(background, "background_color", null) || "white"
    ...
    const background_size = _.get(background, "background_image_size", null) || "cover"
    ...
    return (
      <section
        className={classNames("section", "hero", {
          ...
          "bg-gray": _.get(section, "has_background", null) && background_color === "gray",
          "section--padding":
            _.get(section, "has_background", null) || _.get(section, "image", null),
        })}
      >
        {_.get(section, "has_background", null) &&
          _.get(background, "background_image", null) && (
