...
const data = [
  {
    ...
    color: colors.indigo,
    title: "Atomic",
    subtitle: "Watheia Labs follows atomic design methodologies for all components.",
  },
  {
    icon: "fas fa-palette",
    color: colors.indigo,
  ...
  },
  {
    ...
    subtitle: "We continually deploy improvements and new updates to Watheia Labs.",
  },
]
